...
public class InfibeamImportTask {
					...
					for (int i = 0; i < values.length; i++) {
						...
						if (strArray.length != 2) {
							...
							if(column.equalsIgnoreCase("product_href")){
								data = "http://www.infibeam.com"+data;
							}
							p1.add(Bytes.toBytes("infibeam"),
