...
public class MobileStoreDataProvider extends DataProvider {
	...
	public String getName() {
		// TODO Auto-generated method stub
		return "mobilestore Crawler and Parser";
	}

	@Override
	public boolean crawlWebsite() {
		MobileStoreInfoCrawler crawler = new MobileStoreInfoCrawler();
		try {
			crawler.crawl();
			for (int i = 0; i < SquirreCachedlList.keyList.size(); i++) {
				...
				dataStager.openBatch(key,"mobilestore\\"+key);
	...
	public boolean init(DataStager dataStager){
		...
		mConfigStore = new MobileStoreConfigStore();
		return true;
	}
	
	public static void main(String[] args) {
		MobileStoreDataProvider provider = new MobileStoreDataProvider();
