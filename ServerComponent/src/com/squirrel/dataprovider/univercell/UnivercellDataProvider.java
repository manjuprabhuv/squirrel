...
public class UnivercellDataProvider extends DataProvider {
	...
	public String getName() {
		// TODO Auto-generated method stub
		return "Univercell Crawler and Parser";
	}

	@Override
	public boolean crawlWebsite() {
		UnivercellInfoCrawler crawler = new UnivercellInfoCrawler();
		try {
			crawler.crawl();
			for (int i = 0; i < SquirreCachedlList.keyList.size(); i++) {
				...
				dataStager.openBatch(key,"univercell\\"+key);
	...
	public boolean init(DataStager dataStager){
		...
		mConfigStore = new UnivercellConfigStore();
		return true;
	}
	
	public static void main(String[] args) {
		UnivercellDataProvider provider = new UnivercellDataProvider();
